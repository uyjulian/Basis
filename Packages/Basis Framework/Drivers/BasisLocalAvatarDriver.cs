...
namespace Basis.Scripts.Drivers
{
    public class BasisLocalAvatarDriver : BasisAvatarDriver
    {
        ...
        public void InitialLocalCalibration(BasisLocalPlayer Player)
        {
            ...
            Vector3 hipsDifference = Hips.OutGoingData.position - new float3(Hips.TposeLocal.position.x, Hips.TposeLocal.position.y, 0);
            Player.Avatar.transform.SetLocalPositionAndRotation(hipsDifference, Hips.OutGoingData.rotation);
            CalibrateOffsets();
            BuildBuilder();
        }
